...
### 🏗️ Australian Building Approvals Intelligence Dashboard

An end-to-end Power BI analysis using Australian Bureau of Statistics data to investigate whether growth in building approval value reflects growth in housing activity.

**The analysis explores:**

* Market size and momentum
* Approval value versus dwelling activity
* State contribution and market share
* Regional growth and contraction
* Emerging construction-market trends

### 🏥 Australian Private Health Insurance Intelligence Dashboard

A Power BI analysis of Australian private health insurance data designed to identify changes in market participation, claims and industry performance.

**The analysis explores:**

* Membership and coverage trends
* Benefits and claims patterns
...
* **Business Analysis:** KPI definition, requirements analysis, stakeholder reporting and data storytelling
* **Construction Analytics:** Cost reporting, project controls, procurement and QA/QC
* **Project Systems:** Primavera P6, Aconex, Procore and Revit

## Current Focus

* Developing decision-focused business intelligence case studies
* Preparing for the Microsoft Power BI Data Analyst certification
* Exploring applications of AI, BIM and knowledge management in construction
